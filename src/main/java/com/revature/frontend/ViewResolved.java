...
public class ViewResolved extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String transactionString = om.writeValueAsString(evasDao.finalMethodToEndAllMethods());
        System.out.println("ArrayList: " + evasDao.finalMethodToEndAllMethods());
        System.out.println("String being sent to JS: " + transactionString);
        pw.write(transactionString);
		pw.close();
        
//        String transactionString = om.writeValueAsString(evasDao.getViewResolved(vr));

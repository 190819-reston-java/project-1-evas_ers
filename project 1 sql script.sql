 ...
 *  Database Name   : EVAS
 *  Schema          : Public
 *  Tables          : Employee, Reports, Image 
 *  Keys            : PK Employeeid, PK Requestid, PK Imageid
 * 
 */
...
CREATE TABLE Image( 
    ...
    FOREIGN KEY (imageid) REFERENCES Request(requestid)
...
-------------------------------------------
SELECT * FROM Employee WHERE employeeemail = 'ev' AND employeepassword = '4321';
...
------------------------------------------
DROP VIEW "pendingrequest";
CREATE OR REPLACE VIEW "pendingrequest" AS
SELECT employeelastname, employeefirstname, requeststatus, requestcatagory,   
...
SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto;

SELECT * FROM request_with_manager;

---------------
---------------
DROP VIEW "viewpending";

CREATE OR REPLACE VIEW "viewpending" AS
SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" 
FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto WHERE r.requeststatus = 'pending';

SELECT * FROM viewpending;

--------------------------------

DROP VIEW "viewresolved";

CREATE OR REPLACE VIEW "viewresolved" AS
SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" 
FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto WHERE r.requeststatus = 'resolved';

SELECT * FROM viewresolved;

-------------------------------
DROP VIEW "viewdenied";

CREATE OR REPLACE VIEW "viewdenied" AS
SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" 
FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto WHERE r.requeststatus = 'denied';

SELECT * FROM viewdenied;

-------------------------------

SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" 
FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto WHERE r.requeststatus = 'resolved' AND r.employeerequest = 9; --e.employeeid = 5;

------------------------

SELECT r.requestid "Transaction", r.employeerequest "Employee Id", concat(e.employeefirstname , ' ', e.employeelastname) "Employee Name", r.requestvalue "Requested Amount", r.requestcatagory "Catagory", r.requestdescription "Description", r.requestinformation "Information", r.requeststatus "Status", concat(m.employeefirstname , ' ', m.employeelastname) "Manager" 
FROM request r INNER join employee e ON r.employeerequest = e.employeeid INNER JOIN employee m ON m.employeeid = e.reportsto WHERE e.employeeid = 5; r.requestid = 6; --e.employeeid = 5;
